    ...
    public partial class IdentityInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bill_", x => x.BillId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Draw_", x => x.DrawId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FirstNames = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    LastNames = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("DetailPK", x => x.DetailId);
                    table.ForeignKey(
                        name: "DetailFK_Bill",
                        column: x => x.BillId,
                        principalTable: "Bill_",
                        principalColumn: "BillId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "DetailFK_Draw",
                        column: x => x.DrawId,
                        principalTable: "Draw_",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillDetail__BillId",
                table: "BillDetail_",
                column: "BillId");

            migrationBuilder.CreateIndex(
                name: "IX_BillDetail__DrawId",
                table: "BillDetail_",
                column: "DrawId");
